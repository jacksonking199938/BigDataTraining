...
//    val url = "jdbc:hive2://bigdata37.depts.bingosoft.net:22237/user29_db"
    val url = "jdbc:postgresql://bigdata28.depts.bingosoft.net:25432/user29_db"
...
//      resultSet.close()
      ...
      //查询t_rk_jbxx表数据
      println("表数据：")
      var resultSet = statement.executeQuery("select * from t_rk_jbxx limit 10")
      while (resultSet.next) {
